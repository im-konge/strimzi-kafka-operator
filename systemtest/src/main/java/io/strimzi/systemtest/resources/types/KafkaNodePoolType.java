...
public class KafkaNodePoolType implements ResourceType<KafkaNodePool> {
    private MixedOperation<KafkaNodePool, KafkaNodePoolList, Resource<KafkaNodePool>> client;
    ...
    public void create(KafkaNodePool kafkaNodePool) {
        client.resource(kafkaNodePool).create();
    }

    @Override
    public void update(KafkaNodePool kafkaNodePool) {
        client.resource(kafkaNodePool).update();
    }
