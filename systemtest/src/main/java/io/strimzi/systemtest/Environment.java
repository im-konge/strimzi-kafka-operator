...
public class Environment {
    ...
    public static final InstallType CLUSTER_OPERATOR_INSTALL_TYPE_TEST_FRAME = getOrDefault(CLUSTER_OPERATOR_INSTALL_TYPE_ENV, value -> InstallType.valueOf(value.toUpperCase(Locale.ENGLISH)), InstallType.Yaml);
